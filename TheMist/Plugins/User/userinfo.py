...
from TheMist.__help__ import STATS, USER_INFO
import TheMist.Database.userinfo_sql as sql
from TheMist.Plugins.disable import DisableAbleCommandHandler
from TheMist.Database.global_bans_sql import is_user_gbanned
from TheMist.Database.afk_sql import is_afk, check_afk_status
from TheMist.Database.users_sql import get_user_num_chats
from TheMist.Handlers.validation import sudo_plus, user_admin, support_plus
from TheMist.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'TheMist Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/TheMist_Updates">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/TheMist_Updates)
"""
__mod_name__ = "Infos"
