...
from TheMist.Handlers.managers import CMD_STARTERS, SpamChecker
from TheMist.Handlers.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from TheMist.Database import disable_sql as sql
