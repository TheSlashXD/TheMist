...
from TheMist.Handlers.validation import is_user_admin
...
from TheMist.Plugins import ALL_MODULES
from TheMist.__help__ import (
get_help, 
help_button, 
get_settings, 
settings_button, 
...
PM_START_TEXT = """ 
────「 [{}](https://telegra.ph/file/6efabe8aaae66fae5ccd8.jpg) 」────
Hello *{}*, My name is *{}*! 
...
def start(update: Update, context: CallbackContext):
    ...
    [
        ...
        InlineKeyboardButton(
            text="Bot Info", callback_data="TheMist_"
        ),
    ],
    [
...
def TheMist_about_callback(update: Update, context: CallbackContext):
    first_name = update.effective_user.first_name
    query = update.callback_query
    if query.data == "TheMist_":
        query.message.edit_text(
            ...
            \n\n*If you have any Question, You can join Support Chat.*""".format(
                        escape_markdown(first_name), escape_markdown(context.bot.first_name)),
            parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                   [
                     ...
                     InlineKeyboardButton(text="Updates", url="https://t.me/TheSlashXD"),
                   ],
                   [
                    InlineKeyboardButton(text="Back", callback_data="TheMist_back")
                   ]
                ]
            ),
        )
    elif query.data == "TheMist_back":
        query.message.edit_text(
                PM_START_TEXT.format(
                        escape_markdown(first_name), escape_markdown(context.bot.first_name)),
                reply_markup=InlineKeyboardMarkup([
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(TheMist_about_callback, pattern=r"TheMist_", run_async=True)
